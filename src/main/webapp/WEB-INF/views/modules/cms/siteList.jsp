            ...
            <div class="row">
                <div class="col-sm-12">
                    <form:form id="searchForm" modelAttribute="site" action="${ctx}/cms/site/" method="post" class="form-inline">
                        ...
                        <table:sortColumn id="orderBy" name="orderBy" value="${site.orderBy}" callback="sortOrRefresh();"/><!-- 支持排序 -->
                    ...
                    <tr>
                        ...
                        <td>
                            <shiro:hasPermission name="cms:site:edit">
                                ...
                                <a href="#" onclick="return confirmx('确认要删除该数据吗？', '${ctx}/cms/site/delete?id=${bean.id}')"><i class="fa fa-trash"></i>删除</a>
                            </shiro:hasPermission>
                        </td>
                    </tr>
                </c:forEach>
