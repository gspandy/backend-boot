...
<form:form id="inputForm" modelAttribute="sysDict" action="${ctx}/sys/dict/save" method="post" class="form-horizontal">
    ...
    <table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
        ...
        <tr>
            ...
            <td><form:input path="label" htmlEscape="false" maxlength="50" class="form-control required abc"/></td>
            <td class="active"><label class="pull-right">类型值:</label></td>
            <td><form:input path="value" htmlEscape="false" maxlength="50" class="form-control required"/></td>
        </tr>
        <tr>
